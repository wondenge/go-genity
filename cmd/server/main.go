...
import (
	...
	"github.com/wondenge/go-genity/internal/config"
	"github.com/wondenge/go-genity/internal/errors"
	"github.com/wondenge/go-genity/internal/genity"
	"github.com/wondenge/go-genity/internal/healthcheck"
	"github.com/wondenge/go-genity/pkg/accesslog"
...
func buildHandler(logger log.Logger, db *dbcontext.DB, cfg *config.Config) http.Handler {
	...
	genity.RegisterHandlers(rg.Group(""),
		genity.NewService(genity.NewRepository(db, logger), logger),
		authHandler, logger,
	)
